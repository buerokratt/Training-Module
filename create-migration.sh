...
echo "        <sqlFile path=\"changelog/${sql_migration_file}\" />" >> "$liquibase_migration_file_path"
echo "        <rollback>" >> "$liquibase_migration_file_path"
echo "            <sqlFile path=\"changelog/${rollback_sql_migration_file}\" />" >> "$liquibase_migration_file_path"
echo "        </rollback>" >> "$liquibase_migration_file_path"
