          ...
          buildSaveCell(
            ...
            () =>
              ...
              responseSaveMutation.mutate({
                id: editableRow.id,
                text: editingTrainingTitle ?? props.row.original.text,
              }),
            () => {
        ...
        <Card>
          <Track justify="between" gap={16}>
            <div style={{ flex: 1 }}>
              <Track gap={16}>
                <p>utter_</p>
                <FormInput {...register('name')} label={t('training.responses.responseName')} hideLabel />
                <Controller
                  name="text"
                  control={control}
                  render={({ field }) => (
        ...
        <Dialog
          ...
          footer={
            <>
              ...
              <Button appearance="error" onClick={() => responseDeleteMutation.mutate({ response: deletableRow })}>
                {t('global.yes')}
              </Button>
            </>
          }
...
const buildSaveCell = (isEditable: boolean, onSave: () => void, onEdit: () => void) => {
  if (isEditable) {
    return (
  ...
  return (
    <Button appearance="text" onClick={onEdit}>
