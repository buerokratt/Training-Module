...
import IntentExamplesEntry from '../Intents/IntentExamplesEntry';
import { Intent } from '../../../types/intent';
import LoadingDialog from "../../../components/LoadingDialog";
import i18n from '../../../../i18n';

type IntentsWithRuleTableProps = {
  examples: string[];
...
const IntentsWithRuleTable: FC<IntentsWithRuleTableProps> = ({
                                                             examples,
                                                             onAddNewExample,
                                                             entities,
                                                             selectedIntent,
...
export default IntentsWithRuleTable;
